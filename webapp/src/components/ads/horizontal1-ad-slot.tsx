...
const SLOT_SLUG = "leaderboard";
const SIZE_LABEL = "728x90";
...
export function Horizontal1AdSlot({ device = "desktop", className }: Horizontal1AdSlotProps) {
    ...
    >
      {ad.renderMode === "html" ? (
        <div
          ...
          style={{ maxWidth: ad.width ? `${ad.width}px` : "728px" }}
